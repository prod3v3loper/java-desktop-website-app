...
If you are still having difficulty after looking over your configuration carefully, please post a question to [StackOverflow with the MVC tag](http://stackoverflow.com/tags/java-desktop-website-app). This way you help others to help you.
...
Write here your [issues](https://github.com/prod3v3loper/java-desktop-website-app/issues).
...
Show all [pulls](https://github.com/prod3v3loper/java-desktop-website-app/pulls).